...
/**
 * The slot for offhand
 *
 * @author Gunging
 * @since 1.0.0
 */
public class ISESOffhand extends ISESpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISESOffhand(@NotNull ISESpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMEntity<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISESOffhand withOptions(@NotNull String options) { return getStatements().OFFHAND; }
