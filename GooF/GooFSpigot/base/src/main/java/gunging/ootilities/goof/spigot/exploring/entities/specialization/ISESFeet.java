 ...
 * @since 1.0.0
 */
public class ISESFeet extends ISESpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISESFeet(@NotNull ISESpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMEntity<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISESFeet withOptions(@NotNull String options) { return getStatements().FEET; }
     ...
     */
    @Override
    public @NotNull SpigotEquipmentSlot getEquipmentSlot() { return getStatements().getMinecraft().getEquipmentSlots().wrap(EquipmentSlot.FEET); }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMEntity<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMEntity<?>> elaborator) {
        ...
        ret.add(new ISEEntityExplorer(getStatements().FEET));
