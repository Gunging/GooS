 ...
 * @since 1.0.0
 */
public class ISPSCraftingResult extends ISPSpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISPSCraftingResult(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSCraftingResult withOptions(@NotNull String options) { return getStatements().CRAFTING_RESULT; }
     ...
     * @since 1.0.0
     */
    @Override public @Nullable GBMItemStack<?> readItemStack(@NotNull GBMPlayer<?> target) { return target.getCraftingItem(GBMCraftingSlots.RESULT); }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    @Override public void writeItemStack(@NotNull GBMPlayer<?> target, @Nullable GBMItemStack<?> item) { target.setCraftingItem(GBMCraftingSlots.RESULT, item); }
}