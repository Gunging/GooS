 ...
 * @since 1.0.0
 */
public class ISPSArmor extends ISPSpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISPSArmor(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSArmor withOptions(@NotNull String options) { return getStatements().ARMOR; }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        ret.add(new ISPPlayerExplorer(getStatements().CHEST));
