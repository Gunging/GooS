 ...
 * @since 1.0.0
 */
public class ISPSAllEnderchest extends ISPSpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISPSAllEnderchest(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSAllEnderchest withOptions(@NotNull String options) { return getStatements().ALL_ENDERCHEST; }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        return new ArrayList<>((new ISPPlayerExplorer(getStatements().ENDERCHEST.of(0, elaborator.getElaboratee().getEnderchest().getSize())).elaborate(elaborator)));
    }
