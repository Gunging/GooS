...
/**
 * The four slots of the armor
 *
 * @author Gunging
 * @since 1.0.0
 */
public class ISESArmor extends ISESpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISESArmor(@NotNull ISESpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMEntity<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISESArmor withOptions(@NotNull String options) { return getStatements().ARMOR; }
