 ...
 * @since 1.0.0
 */
public class ISPSOffhand extends ISPSpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISPSOffhand(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSOffhand withOptions(@NotNull String options) { return getStatements().OFFHAND; }
     ...
     */
    @Override
    public @NotNull SpigotEquipmentSlot getEquipmentSlot() { return getStatements().getMinecraft().getEquipmentSlots().wrap(EquipmentSlot.OFF_HAND); }
    ...
    @Override public @NotNull ArrayList<gunging.ootilities.goob.exploring.ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        ret.add(new ISPPlayerExplorer(getStatements().OFFHAND));
