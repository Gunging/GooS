 ...
 * @since 1.0.0
 */
public class ISPSAllExtended extends ISPSpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISPSAllExtended(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSAllExtended withOptions(@NotNull String options) { return getStatements().ALL_EXTENDED; }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        ret.addAll(new ISPPlayerExplorer(getStatements().ALL).elaborate(elaborator));
        ret.addAll(new ISPPlayerExplorer(getStatements().ALL_CRAFTING).elaborate(elaborator));
