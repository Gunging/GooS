 ...
 * @since 1.0.0
 */
public class ISPSChestplate extends ISPSpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISPSChestplate(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSChestplate withOptions(@NotNull String options) { return getStatements().CHEST; }
