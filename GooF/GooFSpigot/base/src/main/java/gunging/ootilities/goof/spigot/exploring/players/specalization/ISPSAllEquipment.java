 ...
 * @since 1.0.0
 */
public class ISPSAllEquipment extends ISPSpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISPSAllEquipment(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSAllEquipment withOptions(@NotNull String options) { return getStatements().ALL_EQUIPMENT; }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        ret.addAll(new ISPPlayerExplorer(getStatements().HANDS).elaborate(elaborator));
