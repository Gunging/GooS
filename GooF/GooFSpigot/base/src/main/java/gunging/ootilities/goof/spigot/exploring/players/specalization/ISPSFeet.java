 ...
 * @since 1.0.0
 */
public class ISPSFeet extends ISPSpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISPSFeet(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISPSFeet withOptions(@NotNull String options) { return getStatements().FEET; }

    /**
     * @author Gunging
     * @since 1.0.0
     */
    @Override public @NotNull SpigotEquipmentSlot getEquipmentSlot() { return getStatements().getMinecraft().getEquipmentSlots().wrap(EquipmentSlot.FEET); }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        ret.add(new ISPPlayerExplorer(getStatements().FEET));
