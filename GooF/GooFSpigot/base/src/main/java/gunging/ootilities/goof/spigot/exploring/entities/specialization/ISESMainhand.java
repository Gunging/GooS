...
/**
 * The slot for held item
 *
 * @author Gunging
 * @since 1.0.0
 */
public class ISESMainhand extends ISESpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISESMainhand(@NotNull ISESpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMEntity<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISESMainhand withOptions(@NotNull String options) { return getStatements().MAINHAND; }
