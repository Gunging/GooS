 ...
 * @since 1.0.0
 */
public class ISESHead extends ISESpigotEquipmentStatement {
     ...
     * @since 1.0.0
     */
    public ISESHead(@NotNull ISESpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMEntity<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable ISESHead withOptions(@NotNull String options) { return getStatements().HEAD; }
     ...
     */
    @Override
    public @NotNull SpigotEquipmentSlot getEquipmentSlot() { return getStatements().getMinecraft().getEquipmentSlots().wrap(EquipmentSlot.HEAD); }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMEntity<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMEntity<?>> elaborator) {
        ...
        ret.add(new ISEEntityExplorer(getStatements().HEAD));
