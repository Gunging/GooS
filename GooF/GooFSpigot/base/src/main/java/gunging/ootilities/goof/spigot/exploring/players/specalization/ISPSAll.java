 ...
 * @since 1.0.0
 */
public class ISPSAll extends ISPSpigotStatement {
     ...
     * @since 1.0.0
     */
    public ISPSAll(@NotNull ISPSpigotStatements statements, @NotNull GOOBWrapperBase<? extends GBMPlayer<?>,?> wrapper, @NotNull GBMNamespacedKey<?> statementName) {
     ...
     * @since 1.0.0
     */
    @Override public @NotNull ISPSAll withOptions(@NotNull String options) { return getStatements().ALL; }
    ...
    @Override public @NotNull ArrayList<ItemStackExplorer<GBMPlayer<?>>> whenElaborated(@NotNull ItemExplorerElaborator<? extends GBMPlayer<?>> elaborator) {
        ...
        ret.addAll(new ISPPlayerExplorer(getStatements().ARMOR).elaborate(elaborator));
        ret.addAll(new ISPPlayerExplorer(getStatements().MAIN).elaborate(elaborator));
