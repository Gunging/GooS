 ...
 * @since 1.0.0
 */
public class GOOFSpigotHook implements GOOBDualInitHook<GOOFSpigot, JavaPlugin> {

    /**
     * @author Gunging
     * @since 1.0.0
     */
    @Override public @Nullable GOOFSpigot hookOnLoad(@NotNull GOOBEngine engine, @NotNull JavaPlugin server, @Nullable FriendlyFeedbackProvider ffp) {
     ...
     * @since 1.0.0
     */
    @Override public @Nullable GOOFSpigot hookOnEnable(@NotNull GOOBEngine engine, @NotNull JavaPlugin server, @Nullable FriendlyFeedbackProvider ffp) {
